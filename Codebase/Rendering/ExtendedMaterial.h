...
protected:
	...
	std::vector<std::pair<shaderResourceLocation, Mat3Graphics>> m_uniformMat3s;
...
public:
	...
	shaderResourceLocation Set(const std::string& uniformName, const Mat3Graphics& mat3);
	...
	void Set(const shaderResourceLocation& uniformLocation, const Mat3Graphics& mat3);
