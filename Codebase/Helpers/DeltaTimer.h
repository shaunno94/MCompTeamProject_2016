...
template <>
float DeltaTimer<float>::Peek(float timeResolution)
{
	return (Age(1.0f) - lastAge) * timeResolution;
}

template <>
double DeltaTimer<double>::Peek(float timeResolution)
{
	return (Age(1.0) - lastAge) * timeResolution;
}


template <>
float DeltaTimer<float>::Get(float timeResolution)
{
...
template <>
double DeltaTimer<double>::Get(float timeResolution)
{
...
template <>
float DeltaTimer<float>::PeekMin(float minDelta, float timeResolution)
{
...
template <>
double DeltaTimer<double>::PeekMin(float minDelta, float timeResolution)
{
...
template <>
float DeltaTimer<float>::GetMin(float minDelta, float timeResolution)
{
	float newAge = Age(1.0f);
	float result = newAge - lastAge;
...
template <>
double DeltaTimer<double>::GetMin(float minDelta, float timeResolution)
{
	double newAge = Age(1.0);
	double result = newAge - lastAge;
