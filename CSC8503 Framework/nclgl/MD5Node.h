...
public:
	...
	*/
	...
	bool	GetParentLocalOrientation(const string&name, QuatGraphics &t);
	bool	GetParentWorldOrientation(const string&name, QuatGraphics &t);

	bool	GetParentLocalTransform(const string&name, Mat4Graphics &t);
	bool	GetParentWorldTransform(const string&name, Mat4Graphics &t);

	bool	GetJointLocalTransform(const string&name, Mat4Graphics &t);
	bool	SetJointLocalTransform(const string &name, Mat4Graphics &t);

	bool	GetJointWorldTransform(const string&name, Mat4Graphics &t);
	bool	SetJointWorldTransform(const string &name, Mat4Graphics &t);
